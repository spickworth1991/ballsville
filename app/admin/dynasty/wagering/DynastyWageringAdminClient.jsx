  ...
  async function saveAll() {
    ...
    try {
      ...
      const payload = rows.map((r) => ({
        ...
        finalist1_name: r.finalist1_name || null,
        finalist1_choice: r.finalist1_choice || "bank",
        finalist1_score: r.finalist1_score === "" ? null : Number(r.finalist1_score),

        finalist2_name: r.finalist2_name || null,
        finalist2_choice: r.finalist2_choice || "bank",
        finalist2_score: r.finalist2_score === "" ? null : Number(r.finalist2_score),

        league_winner: r.league_winner || null,
        notes: r.notes || null,
      }));

      const { error } = await supabase
        .from("dynasty_wager_tracker")
        .upsert(payload, { onConflict: "season,group_name,league_name" });
