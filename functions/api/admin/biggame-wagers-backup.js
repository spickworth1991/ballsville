// functions/api/admin/biggame-wagers-backup.js
//
// GET  /api/admin/biggame-wagers-backup?season=2025
//   -> { ok: true, data: <backupDoc|null>, meta: <metaDoc|null> }
// POST /api/admin/biggame-wagers-backup?season=2025
...
async function touchManifest(env, season) {
  ...
  try {
    ...
    const manifestKey = `data/manifests/biggame-wagers_${season}.json`;
