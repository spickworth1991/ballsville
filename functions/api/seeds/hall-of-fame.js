// functions/api/seeds/hall-of-fame.js
//
// Seed data exported from the old Supabase table (one-time migration aid).
// If the R2 JSON does not exist yet, the admin endpoint will return this
// so you can review it in the admin UI and hit Save to write it to R2.
...
export const HALL_OF_FAME_SEED = {
  ...
  "entries": [
    ...
    },
    {
      ...
      "subtitle": "\"It doesnt matter what cards youre dealt. Its what you do with those cards. Never complain, just keep pushing forward. Find a positive in anything and just fight for it\" - Baker Mayfield",
      "imageKey": "",
    ...
    },
    {
      ...
      "subtitle": "\"These leagues were awesome and run very well and were a lot of fun. I will be a player in these leagues, as long as youre doing em\" - freemanc2447",
      "imageKey": "",
